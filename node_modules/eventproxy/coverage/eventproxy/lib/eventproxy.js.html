...
<html lang="en">
<head>
    <title>Code coverage report for eventproxy/lib/eventproxy.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">eventproxy/lib/eventproxy.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.83% <small>(225 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">90.12% <small>(73 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">95% <small>(38 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">97.83% <small>(225 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">eventproxy/lib/</a> &#187; eventproxy.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (hasDefine) {
    // AMD Module or CMD Module
<span class="cstat-no" title="statement not covered" >    define(definition);</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (hasExports) {
    // Node.js Module
    module.exports = definition(require('debug')('eventproxy'));
  } else {
    // Assign to common namespaces or simply the global object (window)
<span class="cstat-no" title="statement not covered" >    this[name] = definition();</span>
  }
})('EventProxy', function (debug) {
  debug = debug || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function () {</span>};</span>
&nbsp;
  /**
   * refs
   */
...
&nbsp;
  ...
  EventProxy.prototype.headbind = function (ev, callback) {
    debug('Add listener for %s', ev);
    this._callbacks[ev] = this._callbacks[ev] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    ...
    if (!eventName) {
      ...
      if (!callback) {
        ...
        if (list) {
          var l = list.length;
          for (var i = 0; i &lt; l; i++) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (callback === list[i]) {
...
&nbsp;
  var later = typeof process !== 'undefined' &amp;&amp; process.nextTick || <span class="fstat-no" title="function not covered" ><span class="branch-2 cbranch-no" title="branch not covered" >function (fn) {</span></span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (argsLength &lt; 3) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Jul 10 2014 12:20:53 GMT+0800 (CST)</div>
</div>
