...
function add(obj) {
    if (!obj) {
      return console.log('无入参');
    }
    var type = obj.type;
    if (!type) {
      return;
    }
    var size = obj.size || 20;
    ...
    patt.setAttribute('width', size);
    patt.setAttribute('height', size);
    ...
    if (type === 'circle') {
      ...
      if (complement) {
        ...
        var i, corner, results = [];
        for (i = 0; i < ref.length; i++) {
          corner = ref[i];
          var c = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
          c.setAttribute('cx', corner[0]);
          c.setAttribute('cy', corner[1]);
    ...
    path.setAttribute('d', 'M 0,10 l 10,-10 M -2.5,2.5 l 5,-5 M 7.5,12.5 l 5,-5');
    path.setAttribute('stroke-width', 2);
    path.setAttribute('shape-rendering', 'auto');
    path.setAttribute('stroke', 'darkorange');
