...
<html>
<head>
    <title>Code coverage report for src/geo/LatLngBounds.js</title>
...
<div class='header high'>
    <h1>Code coverage report for <span class='entity'>src/geo/LatLngBounds.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/geo/</a> &#187; LatLngBounds.js</div>
</div>
<div class='body'>
...
&nbsp;
		...
		} else <span class="missing-if-branch" title="else path not taken"" >E</span>if (obj instanceof L.LatLngBounds) {
