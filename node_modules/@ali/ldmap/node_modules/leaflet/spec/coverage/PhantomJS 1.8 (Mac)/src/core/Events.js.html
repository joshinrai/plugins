...
<html>
<head>
    <title>Code coverage report for src/core/Events.js</title>
...
<div class='header high'>
    <h1>Code coverage report for <span class='entity'>src/core/Events.js</span></h1>
    <h2>
        
        Statements: <span class='metric'>100% <small>(63 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class='metric'>88.24% <small>(60 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/core/</a> &#187; Events.js</div>
</div>
<div class='body'>
...
&nbsp;
		...
		if (typeof types === 'object') {
			for (type in types) {
				<span class="missing-if-branch" title="else path not taken"" >E</span>if (types.hasOwnProperty(type)) {
...
&nbsp;
				if (contextId &amp;&amp; events[objKey]) {
					...
					listeners = events[types[i]] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
				}
&nbsp;
...
&nbsp;
				if (contextId &amp;&amp; listeners.length === 0 &amp;&amp; events[objKey] &amp;&amp; events[objKey][contextId]) {
					...
					events[objLenKey] = (events[objLenKey] || <span class="branch-1 cbranch-no" title="branch not covered" >1)</span> - 1;
				}
			}
		}
&nbsp;
...
&nbsp;
			for (i = 0, len = listeners.length; i &lt; len; i++) {
				listeners[i].action.call(listeners[i].context || <span class="branch-1 cbranch-no" title="branch not covered" >this,</span> event);
			}
		}
&nbsp;
...
&nbsp;
		if (eventsObj) {
			for (contextId in eventsObj) {
				<span class="missing-if-branch" title="else path not taken"" >E</span>if (eventsObj.hasOwnProperty(contextId)) {
