...
<html>
<head>
    <title>Code coverage report for ./suites/map/MapSpec.js</title>
...
<div class='header high'>
    <h1>Code coverage report for <span class='entity'>./suites/map/MapSpec.js</span></h1>
    <h2>
        
        Statements: <span class='metric'>86.26% <small>(113 / 131)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class='metric'>100% <small>(0 / 0)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class='metric'>90.91% <small>(40 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class='metric'>86.26% <small>(113 / 131)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">./suites/map/</a> &#187; MapSpec.js</div>
</div>
<div class='body'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">describe("Map", function () {
	var map,
		spy;
	beforeEach(function () {
...
&nbsp;
	describe("#removeLayer", function () {
		describe("when the last tile layer on a map is removed", function () {
			it("fires a zoomlevelschange event", function () {
				map.whenReady(<span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >					var spy = sinon.spy();</span>
<span class="cstat-no" title="statement not covered" >					var tl = L.tileLayer("{z}{x}{y}", { minZoom:0, maxZoom: 10 }).addTo(map);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >					map.on("zoomlevelschange", spy);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy.called).not.to.be.ok();</span>
<span class="cstat-no" title="statement not covered" >					map.removeLayer(tl);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy.called).to.be.ok();</span>
				});
			});
		});
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >					map.on("zoomlevelschange", spy);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy.called).to.not.be.ok();</span>
<span class="cstat-no" title="statement not covered" >					map.removeLayer(t2);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy.called).to.be.ok();</span>
				});
			});
		});
...
<span class="cstat-no" title="statement not covered" >					map.removeLayer(t2);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy).not.toHaveBeenCalled();</span>
<span class="cstat-no" title="statement not covered" >					map.removeLayer(t3);</span>
<span class="cstat-no" title="statement not covered" >					expect(spy).not.toHaveBeenCalled();</span>
				});
			});
		});
...
&nbsp;
	describe("#eachLayer", function () {
		it("returns self", function () {
			expect(map.eachLayer(<span class="fstat-no" title="function not covered" >function () {</span>})).to.be(map);
		});
&nbsp;
